...
public class EquipmentReportController {
    ...
    public ResponseEntity<EquipmentReport> analyzeLighting(@RequestBody MaintenanceRequest request) throws JsonProcessingException {
        EquipmentReport report = maintenanceService.analyzeAndSave(request);
        return ResponseEntity.ok(report);
    }
    ...
    public ResponseEntity<EquipmentReport> analyzeWeather(@RequestBody MaintenanceRequest request) throws JsonProcessingException {
        EquipmentReport report = maintenanceService.analyzeAndSave(request);
        return ResponseEntity.ok(report);
    }
    ...
    public ResponseEntity<EquipmentReport> analyzeSign(@RequestBody MaintenanceRequest request) throws JsonProcessingException {
        EquipmentReport report = maintenanceService.analyzeAndSave(request);
        return ResponseEntity.ok(report);
    }
     ...
     */
    @DeleteMapping("/equipmentReports/{id}")
    public ResponseEntity<Void> deleteReport(@PathVariable Long id) {
        if (!equipmentReportRepository.existsById(id)) {
            return ResponseEntity.notFound().build();
        }
