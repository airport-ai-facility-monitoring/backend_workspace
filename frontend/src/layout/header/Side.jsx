...
const navItems = [
  ...
  // ✅ 수정된 메뉴
  { text: "Equipment", icon: <StorageIcon />, collapse: true },
];
            ...
            return (
              <React.Fragment key="Equipment">
                <ListItem
                  ...
                  sx={{
                    height: 40,
                    bgcolor: location.pathname.startsWith("/equipment")
                      ? "rgba(255,255,255,0.1)"
                      : "transparent",
                    "&:hover": {
                      bgcolor: "rgba(255, 255, 255, 0.12)",
                ...
                >
                  ...
                  <ListItemText
                    ...
                    primaryTypographyProps={{
                      fontSize: 13,
                      fontWeight: location.pathname.startsWith("/equipment")
                        ? "bold"
                        : "normal",
                      opacity: 0.9,
                    }}
                  ...
                  <List component="div" disablePadding>
                    <ListItem
                      ...
                      sx={{
                        pl: 6,
                        height: 36,
                        bgcolor: location.pathname === "/equipment" ? "rgba(255,255,255,0.1)" : "transparent",
                        "&:hover": { bgcolor: "rgba(255,255,255,0.12)" },
                      }}
                    ...
                    >
                      <ListItemText
                        ...
                        primaryTypographyProps={{
                          fontSize: 12,
                          fontWeight: location.pathname === "/equipment" ? "bold" : "normal",
                          opacity: location.pathname === "/equipment" ? 1 : 0.7,
                        }}
                      />
                    </ListItem>
                    ...
                    <ListItem
                      ...
                      sx={{
                        pl: 6,
                        height: 36,
                        bgcolor: location.pathname === "/equipment/report" ? "rgba(255,255,255,0.1)" : "transparent",
                        "&:hover": { bgcolor: "rgba(255,255,255,0.12)" },
                      }}
                    ...
                    >
                      <ListItemText
                        ...
                        primaryTypographyProps={{
                          fontSize: 12,
                          fontWeight: location.pathname === "/equipment/report" ? "bold" : "normal",
                          opacity: location.pathname === "/equipment/report" ? 1 : 0.7,
                        }}
                      />
                    </ListItem>
                  </List>
